...
def test_free_project_summary_uses_creative_phase_without_episodes(tmp_path: Path) -> None:
    ...
    assert summary.phase == "creative"
    assert summary.workflow_applicable is False
