...
class TestAssistantRoutes:
    ...
    def test_agent_startup_observation_redacts_only_secrets_without_truncating(self):
        ...
        original = RuntimeError(f"{long_detail} at /opt/matrixspooll/runtime.py?line=42")
        startup_err = AgentStartupError(
            "wrapper",
            sdk_stderr=(
        ...
        assert "/opt/matrixspooll/runtime.py?line=42" in body
        ...
        assert "/opt/matrixspooll/runtime.py?line=42" in raw_exception["message"]
