...
_TASK_FAILURE_ACTIONS: dict[str, GenerationAction] = {
    ...
    "video_reference_videos_duration_exceeded": GenerationAction.FIX_INPUT,
    "video_reference_video_duration_unsupported": GenerationAction.FIX_INPUT,
    ...
    "free_creation_t2v_unsupported": GenerationAction.CONFIGURE_PROVIDER,
    "free_creation_first_frame_unsupported": GenerationAction.CONFIGURE_PROVIDER,
    "free_creation_last_frame_unsupported": GenerationAction.CONFIGURE_PROVIDER,
    "free_creation_reference_images_unsupported": GenerationAction.CONFIGURE_PROVIDER,
    "free_creation_reference_videos_unsupported": GenerationAction.CONFIGURE_PROVIDER,
    "free_creation_reference_audio_unsupported": GenerationAction.CONFIGURE_PROVIDER,
    "free_creation_video_edit_unsupported": GenerationAction.CONFIGURE_PROVIDER,
    ...
    "video_duration_unsupported": GenerationAction.FIX_INPUT,
    "video_aspect_ratio_unsupported": GenerationAction.FIX_INPUT,
    "video_resolution_required": GenerationAction.FIX_INPUT,
    "video_resolution_unsupported": GenerationAction.FIX_INPUT,
    "video_prompt_required": GenerationAction.FIX_INPUT,
    "free_creation_input_combination_unsupported": GenerationAction.FIX_INPUT,
    ...
    "free_creation_failed": GenerationAction.RETRY,
    "video_first_frame_content_rejected": GenerationAction.FIX_INPUT,
    "video_input_image_content_rejected": GenerationAction.FIX_INPUT,
    "video_input_text_content_rejected": GenerationAction.FIX_INPUT,
    "video_last_frame_content_rejected": GenerationAction.FIX_INPUT,
    "video_output_content_rejected": GenerationAction.FIX_INPUT,
    "video_reference_image_content_rejected": GenerationAction.FIX_INPUT,
}
