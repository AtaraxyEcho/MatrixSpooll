...
class DataValidator:
    ...
    def _validate_project_payload(
        ...
        # 固定工作流项目的生成路线必填二值；自由项目不适用，必须落盘为 null。
        generation_mode = project.get("generation_mode")
        if content_mode == "free":
            if generation_mode is not None:
                errors.append(_m("val_generation_mode_invalid", value=generation_mode, allowed="null"))
        ...
        if aspect_ratio is not None and not is_valid_aspect_ratio(aspect_ratio):
            errors.append(_m("val_aspect_ratio_invalid", value=repr(aspect_ratio)))
        ...
        if content_mode == "free":
            ...
            if not isinstance(episodes, list):
                ...
                errors.append(_m("val_field_must_be_empty", field="episodes"))
            return
