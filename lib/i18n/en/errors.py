MESSAGES = {
    ...
    "admin_username_length": "Username must be between {min} and {max} characters",
    "admin_username_start": "Username must start with a letter",
    "admin_username_characters": "Username may contain only English letters, numbers, ., _, or -",
    "admin_username_separators": "Username cannot end with a separator or contain consecutive separators",
    "admin_user_exists": "Username already exists",
    "admin_nickname_length": "Nickname must be between {min} and {max} characters",
    "admin_nickname_characters": "Nickname may contain only Chinese/English letters, digits, underscores, hyphens, and middle dots (no spaces)",
    "admin_nickname_banned": "Nickname contains restricted words",
    ...
    "admin_session_not_found": "The login session was not found",
    "admin_task_not_found": "The task was not found",
    "admin_task_not_active": "The task is no longer cancellable",
    "admin_task_retry_terminal_only": "Only failed or cancelled tasks can be retried",
    ...
    "token_legacy_rejected": "This sign-in credential format is no longer accepted. Please sign in again",
    "download_access_denied": "The download credential is no longer valid or you cannot access this project",
    "pricing_unconfigured": "This model has no valid pricing configured; cost was not recorded",
    "provider_base_url_forbidden": "Provider base URL is not allowed: {reason}",
    "api_key_invalid": "The API key is invalid, expired, revoked, or unavailable",
    ...
    "login_credentials_required": "Enter your username and password",
    ...
    "free_creation_subtitle_render_invalid": "The subtitle track or its source video is not valid",
    "free_creation_subtitle_render_unavailable": "Subtitle rendering is unavailable because FFmpeg is not configured or the video could not be rendered",
    ...
    "project_access_denied": "You do not have access to project '{name}'",
    "project_identifier_ambiguous": "Project name '{name}' is ambiguous; use its project ID",
    "project_delete_active_tasks": "Cannot delete this project while {count} generation task(s) are active. Cancel them and wait for completion first",
    "project_member_user_not_found": "The user does not exist or is inactive",
    "project_member_exists": "This user is already a project member",
    "project_member_not_found": "The project member does not exist",
    "project_owner_change_requires_transfer": "Changing the project owner requires a separate transfer operation",
    ...
    "task_fail_free_creation_failed": "Free creation failed. Please retry or check the generation settings",
    ...
    "video_first_frame_content_rejected": "The first frame did not pass the provider's review: the image may contain sensitive content, a real-person likeness, or private information. Replace the first frame; for authorized real-person material, use the provider's supported identity-verification or licensed-asset process",
    "video_last_frame_content_rejected": "The last frame did not pass the provider's review: the image may contain sensitive content, a real-person likeness, or private information. Replace the last frame; for authorized real-person material, use the provider's supported identity-verification or licensed-asset process",
    "video_reference_image_content_rejected": "Reference image {number} did not pass the provider's review: the image may contain sensitive content, a real-person likeness, or private information. Replace that reference image; for authorized real-person material, use the provider's supported identity-verification or licensed-asset process",
    "video_input_image_content_rejected": "An input image did not pass the provider's review: the image may contain sensitive content, a real-person likeness, or private information. Replace the input image; for authorized real-person material, use the provider's supported identity-verification or licensed-asset process",
    "video_input_text_content_rejected": "The prompt did not pass the provider's content review. Revise descriptions that may involve sensitive content and retry",
    "video_output_content_rejected": "The generated result did not pass the provider's content review. Adjust the prompt or reference media and retry",
    ...
    "free_creation_reference_role_unsupported": "The selected model or output does not support the {role} reference role",
    "free_creation_t2v_unsupported": "{provider}/{model} does not support text-to-video; add a compatible visual input or switch models",
    "free_creation_first_frame_unsupported": "Model {model} does not support first-frame generation",
    "free_creation_last_frame_unsupported": "Model {model} does not support first-and-last-frame generation",
    "free_creation_reference_images_unsupported": "Model {model} does not support reference images",
    "free_creation_reference_videos_unsupported": "Model {model} does not support reference videos",
    "free_creation_reference_audio_unsupported": "Model {model} does not support reference audio",
    ...
    "free_creation_cover_not_found": "Cover for free creation '{id}' does not exist",
    ...
    "free_creation_delete_not_ready": "Active free creations cannot be deleted; cancel the task first",
    ...
    "video_reference_videos_duration_exceeded": "Model {model} allows at most {limit} seconds of reference video in total, but received {total} seconds; reduce or trim the clips",
    "video_reference_video_duration_unsupported": "Reference video {index} for model {model} must be between {min} and {max} seconds, but is {duration} seconds",
    ...
    "free_creation_merge_tools_missing": "Video merging requires FFmpeg and FFprobe. Install both tools and restart the backend service.",
    "free_creation_merge_input_unreadable": "A selected video is damaged or uses a format whose media information cannot be read.",
    ...
    "video_resolution_required": "Model {model} requires a resolution",
