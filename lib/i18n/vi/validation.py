...
MESSAGES = {
    ...
    "val_field_must_be_empty": "{field} phải là mảng rỗng",
    ...
    "arch_upload_too_large": "Tệp dự án vượt quá giới hạn tải lên {max_mb} MB",
    "arch_zip_too_many_entries": "Tệp ZIP có nhiều hơn {max_count} mục",
    "arch_zip_entry_too_large": "Mục ZIP vượt quá giới hạn {max_mb} MB cho mỗi tệp: {name}",
    "arch_zip_expanded_too_large": "Tổng dung lượng ZIP sau giải nén vượt quá {max_mb} MB",
    "arch_zip_compression_ratio_too_high": "Mục ZIP có tỷ lệ nén không an toàn (giới hạn {max_ratio}:1): {name}",
    "arch_multiple_manifests": "ZIP chứa nhiều tệp matrixspooll-export.json nên không xác định được thư mục gốc dự án",
    ...
    "val_aspect_ratio_invalid": "Tỷ lệ khung hình phải là tỷ lệ rộng:cao số nguyên dương; nhận được {value}",
}
