...
async def _execute_free_creation_task_proxy(
    task_type: str,
    project_name: str,
    resource_id: str,
    payload: dict[str, Any],
...
_TASK_EXECUTORS = {
    ...
    "free_image": lambda project_name, resource_id, payload, **kwargs: _execute_free_creation_task_proxy(
        "free_image", project_name, resource_id, payload, **kwargs
    ),
    "free_video": lambda project_name, resource_id, payload, **kwargs: _execute_free_creation_task_proxy(
        "free_video", project_name, resource_id, payload, **kwargs
    ),
