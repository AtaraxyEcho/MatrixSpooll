...
export default {
  ...
  'free_creation_use_as_parent': 'Tiếp tục chỉnh sửa từ kết quả này',
  ...
  'free_creation_agent_prompt_context': 'Tham số sáng tạo: ưu tiên {{preference}}, tỷ lệ khung hình {{ratio}}.',
  ...
  'free_creation_export': 'Xuất tác phẩm',
  ...
  'home_size_hint': 'Chiều rộng và cao từ 256–4096 px. Thay đổi kích thước cũng cập nhật tỷ lệ khung hình.',
