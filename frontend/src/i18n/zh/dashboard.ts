...
export default {
  ...
  'free_creation_use_as_parent': '基于此结果继续编辑',
  ...
  'free_creation_agent_prompt_context': '创作参数：优先生成{{preference}}，画面比例 {{ratio}}。',
  ...
  'home_width': '宽度 W',
  'home_height': '高度 H',
  'home_size_hint': '宽高范围 256–4096 px；修改尺寸会同步更新画面比例。',
  'home_quantity': '生成数量',
