...
export default {
  'tool_name_get_free_creation_options': '读取创作能力',
  'tool_name_submit_free_creation': '创建自由作品',
  'tool_name_inspect_free_creation': '查看自由创作',
  'free_creation_composite_audio': '合成视频配音',
  'free_creation_audio_composite_succeeded': '带配音的新视频已添加到画布',
  'free_creation_audio_composite_failed': '配音合成失败：{{message}}',
  'free_creation_voice_unconfigured': '请先在系统设置中配置音频供应商和默认配音模型。',
  'free_creation_subtitle_timing_hint': '每个非空行会成为一条字幕，系统按视频时长平均分配显示时间。',
  'free_creation_subtitle_cue_count': '{{count}} 条字幕',
  'free_creation_subtitle_placeholder': '每行输入一条字幕内容',
  'free_creation_subtitle_render': '生成带字幕视频',
  'free_creation_subtitle_edit': '编辑字幕',
  'free_creation_subtitle_render_succeeded': '带字幕视频已生成',
  'free_creation_subtitle_render_failed': '生成带字幕视频失败：{{message}}',
  'free_creation_subtitle_delete_succeeded': '字幕已删除',
  'free_creation_subtitle_delete_failed': '删除字幕失败：{{message}}',
  'app_title': '[[brand]]',
  'projects': '项目',
  'create_project': '创建项目',
  'new_project': '新建项目',
  'project_name': '项目名称',
  'project_identity_kicker': '项目信息',
  'project_identity_title': '项目信息',
  'project_title_hint': '用于项目列表与工作区显示，最多 120 个字符。',
  'project_title': '项目标题',
  ...
  'free_creation_audio': '配音',
  'free_creation_edit': '编辑',
  'free_creation_reference_paths': '参考文件路径（每行一个）',
  'free_creation_aspect_ratio': '画面比例',
  'free_creation_model': '模型',
  'free_creation_model_auto': '自动选择',
  'free_creation_resolution': '分辨率',
  'free_creation_resolution_auto': '自动',
  'free_creation_size': '尺寸（宽 x 高）',
  'free_creation_quantity': '生成数量',
  'free_creation_duration': '视频生成时间',
  'free_creation_submit': '立即生成',
  'free_creation_generating': '生成中…',
  'free_creation_empty': '还没有自由创作结果',
  'free_creation_failed': '生成失败',
  'free_creation_error_generic': '生成失败，请重试或检查生成设置',
  'free_creation_cancel': '取消生成',
  'free_creation_retry': '重试',
  'free_creation_retry_original_model': '按原模型 {{model}} 重试',
  'free_creation_download': '下载结果',
  'free_creation_use_as_parent': '基于此图片继续编辑',
  'free_creation_status_queued': '排队中',
  'free_creation_status_running': '生成中',
  'free_creation_status_cancelling': '停止中',
  'free_creation_status_succeeded': '已完成',
  'free_creation_status_failed': '失败',
  'free_creation_status_cancelled': '已取消',
  'free_creation_zoom_in': '放大画布',
  'free_creation_zoom_out': '缩小画布',
  'free_creation_reset_canvas': '重置画布视图',
  'free_creation_snap_enable': '启用元素对齐吸附',
  'free_creation_snap_disable': '关闭元素对齐吸附',
  'free_creation_workspace': '自由创作画布',
  'free_creation_canvas_load_failed': '画布布局加载失败，请重试',
  'free_creation_canvas_retry': '重试加载画布',
  'free_creation_reference': '参考素材',
  'free_creation_mode': '创作模式',
  'free_creation_mode_agent': 'Agent 模式',
  'free_creation_mode_image': '生成图片',
  'free_creation_mode_video': '生成视频',
  'free_creation_agent_parameters': 'Agent 参数',
  'free_creation_agent_generation_preference': '生成偏好',
  'free_creation_agent_preference_image': '图片',
  'free_creation_agent_preference_video': '视频',
  'free_creation_agent_model': '模型',
  'free_creation_agent_auto_mode': '自动模式',
  'free_creation_agent_custom_mode': '自定义',
  'free_creation_agent_smart_ratio': '智能',
  'free_creation_agent_recommended': '推荐',
  'free_creation_agent_model_auto': '自动推荐模型',
  'free_creation_agent_resolution_auto': '自动推荐分辨率',
  'free_creation_agent_model_search': '搜索 Agent 模型',
  'free_creation_agent_prompt_context': '创作参数：优先生成{{preference}}，画面比例 {{ratio}}，模型 {{model}}，分辨率 {{resolution}}。自动项需根据用户意图和可用模型能力选择。',
  'free_creation_agent_reference_context': '参考素材：{{files}}。',
  'free_creation_reference_mode': '参考方式',
  'free_creation_reference_mode_all': '全能参考',
  'free_creation_reference_mode_frames': '首尾帧',
  'free_creation_reference_content': '参考内容',
  'free_creation_first_frame': '首帧',
  'free_creation_last_frame': '尾帧',
  'free_creation_swap_frames': '交换首尾帧',
  'free_creation_frames_require_images': '首尾帧仅支持图片素材',
  'free_creation_frames_require_omni': '首尾帧模式只接受图片，视频请切换到全能参考',
  'media_tools_kicker': '本地媒体工具',
  'media_tools_title': '后期处理运行环境',
  'media_tools_description': '合并片段、合成配音和渲染字幕依赖服务器可用的 FFmpeg 工具。',
  ...
  'free_creation_frames_model_unsupported': '当前模型不支持首尾帧生成',
  'free_creation_reference_capacity': '参考素材容量',
  'free_creation_reference_count': '{{count}} / {{limit}} 个参考',
  'free_creation_reference_limit_reached': '当前模型最多支持 {{count}} 个参考文件',
  'free_creation_reference_type_unsupported': '当前模型不支持这种文件类型',
  'free_creation_drag_reference_hint': '可将文件拖到此处添加参考',
  'free_creation_drop_reference': '松开即可添加参考',
  'free_creation_drop_on_canvas': '松开文件以添加到画布',
  'free_creation_reference_assets': '引用资产',
  'free_creation_asset_picker_title': '从资产库引用',
  'free_creation_asset_picker_description': '直接复用人物、场景和道具图片，无需重复上传。',
  'free_creation_asset_picker_empty': '该分类中暂无带图片的资产',
  'free_creation_asset_selected': '已选择 {{count}} 个资产',
  'free_creation_action_read_only': '只读模式下无法执行此操作',
  ...
  'free_creation_reference_roles_incomplete': '请为每份已绑定素材选择用途',
  'free_creation_reference_roles_incompatible': '部分素材用途不受当前模型支持',
  'free_creation_reference_role_limit': '当前模型支持的该用途素材数量更少',
  'free_creation_reference_role_first_frame': '首帧',
  'free_creation_reference_role_last_frame': '尾帧',
  'free_creation_reference_role_reference_image': '参考图片',
  'free_creation_reference_role_reference_video': '参考视频',
  'free_creation_reference_role_reference_audio': '参考音频',
  ...
  'free_creation_preview_truncated': '内容较长，仅显示前 120,000 个字符',
  'free_creation_add_reference': '引用到创作框',
  'free_creation_remove_reference': '移除引用',
  'free_creation_upload_reference': '上传参考素材',
  'free_creation_more_actions': '更多操作',
  'free_creation_delete': '删除',
  'free_creation_delete_selected': '删除所选',
  'free_creation_hide': '隐藏',
  'free_creation_restore': '恢复',
  'free_creation_selected': '已选中',
  'free_creation_shortcuts': '快捷键',
  'free_creation_relations': '内容关系',
  'free_creation_relations_selected': '仅所选',
  'free_creation_relations_all': '视口内全部',
  'free_creation_relations_off': '隐藏关系',
  'free_creation_relations_limited': '为保持画布流畅，另有 {{count}} 条关系暂未显示',
  'free_creation_relation_summary': '{{upstream}} 个来源，{{downstream}} 个派生结果',
  'free_creation_relation_summary_short': '{{upstream}} 来源 · {{downstream}} 结果',
  'free_creation_relation_details': '内容关系',
  'free_creation_relation_close': '关闭关系详情',
  'free_creation_relation_unavailable': '来源不可用',
  'free_creation_relation_upstream': '来源（{{count}}）',
  'free_creation_relation_downstream': '派生结果（{{count}}）',
  'free_creation_relation_no_upstream': '没有来源内容',
  'free_creation_relation_no_downstream': '没有派生结果',
  'free_creation_relation_role_first_frame': '首帧',
  'free_creation_relation_role_last_frame': '尾帧',
  'free_creation_relation_role_reference_image': '参考图片',
  'free_creation_relation_role_reference_video': '参考视频',
  'free_creation_relation_role_reference_audio': '参考音频',
  'free_creation_relation_role_prompt_context': '文本参考',
  'free_creation_relation_role_edit_source': '编辑来源',
  'free_creation_relation_role_subtitle_source': '字幕源视频',
  'free_creation_relation_role_subtitle_render': '字幕合成',
  'free_creation_relation_role_reference': '参考内容',
  'free_creation_continue_from_result': '基于此结果创建新作品',
  'free_creation_continue_ready': '结果和创作设置已带入创作框',
  'free_creation_continue_model_unavailable': '原模型已不可用，已切换为自动选择',
  'free_creation_continue_settings_adjusted': '部分原始参数已不再受支持，请确认当前参数后再生成',
  'free_creation_continue_draft_conflict_title': '保留还是替换当前草稿？',
  'free_creation_continue_draft_conflict_description': '创作框中已有未发送内容，请选择如何使用这个结果',
  'free_creation_continue_add_reference_only': '仅添加为参考',
  'free_creation_continue_replace_draft': '替换当前草稿',
  'free_creation_composer_expand': '展开创作框',
  'free_creation_composer_collapse': '折叠创作框',
  'free_creation_start_creating': '开始创作',
  'free_creation_composer_reference_count': '{{count}} 个参考素材',
  'free_creation_shortcut_undo': '撤回上一次画布操作',
  'free_creation_shortcut_redo': '重做上一次画布操作',
  'free_creation_shortcut_select_all': '选择所有可见卡片',
  'free_creation_shortcut_reference': '引用卡片到创作框',
  'free_creation_shortcut_preview': '预览卡片内容',
  'free_creation_shortcut_move': '移动卡片',
  'free_creation_shortcut_pan': '平移画布',
  'free_creation_shortcut_zoom': '缩放画布',
  'free_creation_shortcut_combo_reference': 'Ctrl/Cmd + 点击',
  'free_creation_shortcut_combo_preview': '双击',
  'free_creation_shortcut_combo_move': '拖拽卡片移动',
  'free_creation_shortcut_combo_pan': 'Space + 拖拽',
  'free_creation_shortcut_combo_zoom': 'Alt + 滚轮',
  'free_creation_shortcut_snap': '临时关闭元素对齐吸附',
  'free_creation_shortcut_combo_snap': 'Alt + 拖拽',
  'free_creation_hide_from_canvas': '从画布隐藏',
  'free_creation_add_selected_references': '引用所选附件（{{count}}）',
  'free_creation_hide_selected': '隐藏所选（{{count}}）',
  'free_creation_restore_selected': '恢复所选（{{count}}）',
  'free_creation_restore_to_canvas': '恢复到画布',
  'free_creation_show_hidden': '显示隐藏的作品（{{count}}）',
  'free_creation_restore_all_hidden': '恢复全部隐藏内容（{{count}}）',
  'free_creation_editing_result': '正在编辑：{{prompt}}',
  'free_creation_cancel_edit': '退出编辑',
  'free_creation_image_parameters': '图片参数',
  'free_creation_video_parameters': '视频参数',
  'free_creation_export': '导出',
  'free_creation_export_project_backup': '导出项目备份',
  'free_creation_export_project_backup_hint': '完整项目 ZIP，可从项目列表重新导入',
  'free_creation_export_selected': '导出所选作品',
  'free_creation_export_request': '导出当前创作请求',
  'free_creation_export_all': '导出全部已完成作品',
  'free_creation_export_started': '作品导出已开始',
  'free_creation_export_failed': '作品导出失败：{{message}}',
  'free_creation_merge_selected': '合并所选视频',
  'free_creation_merge_started': '视频合并已开始',
  'free_creation_merge_failed': '视频合并失败：{{message}}',
  'free_creation_group_selected': '组合所选素材',
  'free_creation_ungroup': '取消组合',
  'free_creation_group_label': '组合 {{count}}',
  'free_creation_arrange_all': '整理全部素材',
  'free_creation_fit_all': '适配全部素材',
  'free_creation_fit_selected': '适配所选素材',
  'free_creation_minimap': '画布导航图',
  'free_creation_arrange_selected': '整理所选素材',
  'free_creation_tools': '创作工具',
  'free_creation_storyboard_plan': '规划分镜',
  'free_creation_storyboard_title': '分镜规划',
  'free_creation_storyboard_subtitle': '先整理镜头，再批量生成分镜图。不会改变普通视频生成流程。',
  'free_creation_storyboard_loading': '正在整理分镜草案…',
  'free_creation_storyboard_name': '分镜计划名称',
  'free_creation_storyboard_default_title': '未命名分镜',
  'free_creation_storyboard_shot_title': '第 {{index}} 个镜头标题',
  'free_creation_storyboard_shot_prompt': '第 {{index}} 个镜头提示词',
  'free_creation_storyboard_move_up': '上移镜头',
  'free_creation_storyboard_move_down': '下移镜头',
  ...
  'free_creation_voice_action': '添加配音',
  'free_creation_voice_title': '生成配音',
  'free_creation_voice_text': '配音文本',
  'free_creation_voice_select': '音色',
  'free_creation_voice_loading': '正在加载音色…',
  'free_creation_voice_unavailable': '当前无法使用配音',
  'free_creation_voice_generate': '生成配音',
  'free_creation_subtitle_action': '添加字幕',
  'free_creation_subtitle_title': '添加字幕',
  'free_creation_subtitle_video': '视频',
  'free_creation_subtitle_text': '字幕文本',
  'free_creation_subtitle_duration': '视频时长（秒）',
  'free_creation_subtitle_create': '创建字幕',
  'free_creation_subtitle_update': '更新字幕',
  'free_creation_subtitle_delete': '删除字幕',
  'free_creation_subtitle_badge': '字幕 {{count}} 条',
  'free_creation_subtitle_video_required': '请先生成视频再添加字幕',
  'free_creation_storyboard_image_ready': '分镜图已生成',
  'free_creation_storyboard_shot_badge': '镜头 {{index}}',
  'home_hero_eyebrow': '输入即所得',
  'home_hero_title': '把下一帧交给你自己。',
  'home_hero_subtitle': '从一个想法开始，只选择真正影响结果的参数；每次创作都会留在对应项目中，方便继续编辑。',
  'home_output_type': '输出类型',
  'home_prompt_label': '创作提示词',
  'home_prompt_placeholder': '描述你想看到的画面或动作……',
  'home_image': '图片生成',
  'home_video': '视频生成',
  'home_model': '模型',
  'home_model_auto': '自动选择',
  'home_model_search': '搜索模型',
  'home_model_no_results': '没有匹配的模型',
  'home_model_keyboard_hint': '按字母键可快速定位模型',
  'home_ratio': '比例',
  'home_resolution': '分辨率',
  'home_size': '尺寸',
  'home_image_settings': '图片参数',
  'home_video_settings': '视频参数',
  'home_width': '宽度 W',
  'home_height': '高度 H',
  'home_size_hint': '可手动输入任一边，另一边会按当前比例联动；最终尺寸受所选模型能力约束。',
  'home_quantity': '生成数量',
  'home_duration': '视频生成时间',
  'home_duration_minimum': '最短 {{value}} 秒',
  'home_auto': '自动',
  'home_generate': '立即生成',
  'home_enter_agent': '进入 Agent',
  'home_generating': '创建中……',
  'home_projects_eyebrow': '项目库',
  'home_projects_title': '最近项目',
  'home_projects_count': '{{count}} 个项目',
  'home_projects_view_all': '查看全部',
  'home_projects_empty': '项目会显示在这里。',
  'home_projects_empty_hint': '在上方输入创作提示词，开始你的第一个自由创作项目。',
  'home_new_project_hint': '打开完整工作流',
  'phase_creative': '创作中',
  ...
  'content_mode_free_desc': '输入即所得——在项目内直接生成图片、视频或编辑版本，不需要剧本、分集或固定生成路线。',
  'aspect_ratio_1_1': '方形 1:1',
  'aspect_ratio_4_3': '标准 4:3',
  'aspect_ratio_3_4': '竖幅 3:4',
  'aspect_ratio_21_9': '宽银幕 21:9',
  'source_kind': '源文件性质',
  ...
  'importing': '导入中...',
  'import_zip': '导入项目 ZIP',
  'import_project_zip_only': '只能导入由 MatrixSpooll 导出的项目 ZIP 备份',
  ...
  'about_title': '关于 MatrixSpooll',
  'about_intro': '查看本部署版本的来源、许可证、修改声明与对应源码。',
  'about_loading': '正在读取信息…',
  'about_origin_title': '项目来源',
  'about_origin_description': 'MatrixSpooll 是基于 ArcReel 修改的版本，并保留原项目要求的署名与来源链接。',
  'about_modified_title': '修改版本声明',
  'about_product': '产品',
  'about_modified_by': '修改者',
  'about_modification_date': '相关修改日期',
  ...
  'save_nickname': '保存昵称',
  'saving_nickname': '正在保存…',
  'nickname_saved': '昵称已更新。',
  'nickname_save_failed': '昵称更新失败，请重试。',
  'avatar_label': '头像',
  'avatar_upload': '上传头像',
  'avatar_uploading': '上传中…',
  'avatar_remove': '移除头像',
  'avatar_hint': '支持 JPG / PNG / WebP，最大 2MB。',
  ...
  'agent_failure_diagnosis_model_or_endpoint_incompatible': '当前模型无法通过已配置的 Anthropic Messages 端点使用。请打开 Agent 设置执行连接测试；若供应商仅提供 OpenAI Chat Completions，请改用模型官方的 Anthropic 兼容地址或其他支持 Anthropic 的供应商。',
  ...
  'project_member_username': '用户名',
  'project_member_username_placeholder': '请输入完整用户名',
  'project_member_role': '项目角色',
  'project_member_add': '添加成员',
  'project_member_add_title': '添加成员',
  'project_member_add_hint': '从用户列表勾选要加入项目的成员。',
  'project_member_add_selected': '添加所选 ({{count}})',
  'project_member_candidates_empty': '暂无可添加的用户。',
  'project_member_selected_count': '已选择 {{count}} 名成员',
  'project_role_editor_hint': '可编辑项目内容、创建生成任务、管理项目设置（不含成员管理）。',
  'project_role_viewer_hint': '只读访问，可查看项目内容与生成结果。',
  'project_member_account': '账号',
  'project_member_actions': '操作',
  'project_role_owner': '所有者',
  'project_role_editor': '编辑者',
  'project_role_viewer': '查看者',
  'project_member_remove': '移除',
  'project_member_no_action': '不可操作',
  'project_members_loading': '正在加载项目成员...',
  'project_members_empty': '暂无项目成员。',
  'project_members_request_failed': '无法加载项目成员。',
  'project_member_added': '成员已添加。',
  'project_member_updated': '成员角色已更新。',
  'project_member_removed': '成员已移除。',
  'project_owner_transfer_title': '转移项目所有权',
  'project_owner_transfer': '确认转移',
  'project_owner_transfer_hint': '新所有者必须已是项目成员；转移后你将成为编辑者。',
  'project_owner_transfer_empty': '暂无其他成员，请先添加成员后再转移所有权。',
  'project_owner_transfer_confirm_title': '确认转移项目所有权？',
  'project_owner_transfer_confirm_description': '将项目所有权转移给 {{username}}？此后你将无法继续管理成员权限。',
  'project_owner_transferred': '项目所有权已转移。',
  'project_member_remove_confirm_title': '移除项目成员？',
  'project_member_remove_confirm_description': '确认将 {{username}} 从此项目移除？',
  'project_members_saving': '正在保存...',
  ...
  'resolution_default_label': '默认分辨率',
  'resolution_default_help': '生成请求未显式选择分辨率时下发给供应商的默认档位；不改变生成页的档位选项。',
  'capability_custom_value_placeholder': '自定义值',
  'capability_custom_add': '添加自定义值',
  'capability_custom_ratio_invalid': '比例格式应为 宽:高（如 16:9）',
  'sync_capabilities_button': '从文档同步能力',
  'sync_capabilities_running': '正在同步…',
  'sync_capabilities_done': '同步完成：更新 {{updated}}、未变化 {{unchanged}}、未匹配参数 {{nodecl}}、失败 {{failed}}',
  'capability_source_user_badge': '手动',
  'capability_source_endpoint_badge': '默认',
  'capability_clear_override': '取消手动调整',
  'vendor_declaration_active': '自动获取',
  'sync_capabilities_failed': '能力同步失败',
  'vendor_capability_badge': '供应商文档',
  'vendor_capability_badge_title': '能力来自供应商文档，同步于 {{time}}',
  'supported_resolutions_label': '分辨率档位',
  'supported_resolutions_help': '生成页可选的分辨率档位，点击 chip 即可调整；自定义值按 API 原样下发',
  'supported_ratios_label': '宽高比',
  'supported_ratios_help': '生成页可选的宽高比，点击 chip 即可调整',
  ...
  'endpoint_anyfast_seedance_display': 'AnyFast Seedance 视频',
  ...
  'project_page_summary': '显示第 {{start}}-{{end}} 条，共 {{total}} 个项目',
  'project_previous_page': '上一页',
  'project_next_page': '下一页',
  ...
  'cred_testing': '测试中…',
  'raw_error': '原始错误',
  'raw_openai_error': 'OpenAI 对比探测错误',
  'is_active': '当前',
  ...
  'openai_compat_probe': 'OpenAI 对比探测',
  'diagnosis_missing_anthropic_suffix': '检测到 base_url 缺少 anthropic 子路径，已自动探测到正确端点',
  'diagnosis_openai_compat_only': '该模型只能通过当前供应商的 OpenAI Chat Completions 接口调用，Claude Agent 无法使用。请改用模型官方的 Anthropic Messages 兼容地址，或更换支持 Anthropic 的供应商。',
  ...
  'free_creation_session_summary': '创作请求',
  'free_creation_session_count': '{{count}} 个请求',
  'free_creation_session_empty': '暂无生成请求',
  'free_creation_request_history': '请求记录',
  'free_creation_toggle_session_summary': '展开或收起请求摘要',
  'free_creation_bound_resources': '{{count}} 个引用素材',
  'free_creation_request_results': '{{completed}}/{{total}} 个结果',
  'free_creation_status_partial': '部分完成',
  'free_creation_mode_t2v': '文生视频',
  'free_creation_mode_first_frame': '首帧引导',
  'free_creation_mode_first_last_frame': '首尾帧过渡',
  'free_creation_mode_reference_image': '参考图创作',
  'free_creation_mode_reference_video': '参考视频创作',
