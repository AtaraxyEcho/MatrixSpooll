...
export default {
  ...
  'free_creation_use_as_parent': 'Continue editing from this result',
  ...
  'free_creation_agent_prompt_context': 'Creation parameters: prefer {{preference}}, aspect ratio {{ratio}}.',
  ...
  'free_creation_export': 'Export work',
  ...
  'home_size_hint': 'Width and height range from 256–4096 px. Editing them also updates the aspect ratio.',
