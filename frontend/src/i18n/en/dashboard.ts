...
export default {
  'tool_name_get_free_creation_options': 'Read creation options',
  'tool_name_submit_free_creation': 'Create free work',
  'tool_name_inspect_free_creation': 'Inspect free creation',
  'free_creation_composite_audio': 'Combine video and voice',
  'free_creation_audio_composite_succeeded': 'A new video with voice was added to the canvas',
  'free_creation_audio_composite_failed': 'Voice compositing failed: {{message}}',
  'free_creation_voice_unconfigured': 'Configure an audio provider and default voice model in System settings to use voice generation.',
  'free_creation_subtitle_timing_hint': 'Each non-empty line becomes one cue; the video duration is divided evenly between cues.',
  'free_creation_subtitle_cue_count': '{{count}} cues',
  'free_creation_subtitle_placeholder': 'Enter one subtitle cue per line',
  'free_creation_subtitle_render': 'Generate subtitled video',
  'free_creation_subtitle_edit': 'Edit subtitles',
  'free_creation_subtitle_render_succeeded': 'Subtitled video generated',
  'free_creation_subtitle_render_failed': 'Failed to generate subtitled video: {{message}}',
  'free_creation_subtitle_delete_succeeded': 'Subtitles deleted',
  'free_creation_subtitle_delete_failed': 'Failed to delete subtitles: {{message}}',
  'app_title': '[[brand]]',
  'projects': 'Projects',
  'create_project': 'Create Project',
  'new_project': 'New Project',
  'project_name': 'Project Name',
  'project_identity_kicker': 'Project details',
  'project_identity_title': 'Project details',
  'project_title_hint': 'Shown in the project list and workspace. Up to 120 characters.',
  ...
  'free_creation_model_auto': 'Auto select',
  'free_creation_resolution': 'Resolution',
  'free_creation_resolution_auto': 'Auto',
  'free_creation_size': 'Size (width x height)',
  'free_creation_quantity': 'Generation count',
  'free_creation_duration': 'Video generation time',
  'free_creation_submit': 'Generate now',
  'free_creation_generating': 'Generating…',
  'free_creation_empty': 'No free creations yet',
  'free_creation_failed': 'Generation failed',
  'free_creation_error_generic': 'Generation failed. Please retry or check the generation settings',
  'free_creation_cancel': 'Cancel generation',
  'free_creation_retry': 'Retry',
  'free_creation_retry_original_model': 'Retry with original model {{model}}',
  'free_creation_download': 'Download result',
  'free_creation_use_as_parent': 'Edit from this image',
  'free_creation_status_queued': 'Queued',
  'free_creation_status_running': 'Generating',
  'free_creation_status_cancelling': 'Stopping',
  'free_creation_status_succeeded': 'Completed',
  'free_creation_status_failed': 'Failed',
  'free_creation_status_cancelled': 'Cancelled',
  'free_creation_zoom_in': 'Zoom in canvas',
  'free_creation_zoom_out': 'Zoom out canvas',
  'free_creation_reset_canvas': 'Reset canvas view',
  'free_creation_snap_enable': 'Enable element snapping',
  'free_creation_snap_disable': 'Disable element snapping',
  'free_creation_workspace': 'Free creation canvas',
  'free_creation_canvas_load_failed': 'Canvas layout could not be loaded. Please retry.',
  'free_creation_canvas_retry': 'Retry canvas loading',
  'free_creation_reference': 'Reference',
  'free_creation_mode': 'Creation mode',
  'free_creation_mode_agent': 'Agent mode',
  'free_creation_mode_image': 'Generate image',
  'free_creation_mode_video': 'Generate video',
  'free_creation_agent_parameters': 'Agent parameters',
  'free_creation_agent_generation_preference': 'Generation preference',
  'free_creation_agent_preference_image': 'Image',
  'free_creation_agent_preference_video': 'Video',
  'free_creation_agent_model': 'Model',
  'free_creation_agent_auto_mode': 'Automatic',
  'free_creation_agent_custom_mode': 'Custom',
  'free_creation_agent_smart_ratio': 'Smart',
  'free_creation_agent_recommended': 'Recommended',
  'free_creation_agent_model_auto': 'Recommend model automatically',
  'free_creation_agent_resolution_auto': 'Recommend resolution automatically',
  'free_creation_agent_model_search': 'Search Agent models',
  'free_creation_agent_prompt_context': 'Creation parameters: prefer {{preference}}, aspect ratio {{ratio}}, model {{model}}, resolution {{resolution}}. For automatic values, choose from available capabilities according to the request.',
  'free_creation_agent_reference_context': 'Reference materials: {{files}}.',
  'free_creation_reference_mode': 'Reference mode',
  'free_creation_reference_mode_all': 'Omni reference',
  'free_creation_reference_mode_frames': 'First and last frames',
  'free_creation_reference_content': 'Reference content',
  'free_creation_first_frame': 'First frame',
  'free_creation_last_frame': 'Last frame',
  'free_creation_swap_frames': 'Swap first and last frames',
  'free_creation_frames_require_images': 'First and last frames only accept images',
  'free_creation_frames_require_omni': 'First/last frame mode accepts images only; switch to Omni reference for video',
  'media_tools_kicker': 'Local media tools',
  'media_tools_title': 'Post-production runtime',
  'media_tools_description': 'Merging clips, compositing voice, and rendering subtitles use the FFmpeg executables available to the server.',
  ...
  'free_creation_frames_model_unsupported': 'The selected model does not support first and last frames',
  'free_creation_reference_capacity': 'Reference capacity',
  'free_creation_reference_count': '{{count}} / {{limit}} references',
  'free_creation_reference_limit_reached': 'This model accepts up to {{count}} reference files',
  'free_creation_reference_type_unsupported': 'This file type is not supported by the selected model',
  'free_creation_drag_reference_hint': 'Drop files here to add references',
  'free_creation_drop_reference': 'Release to add references',
  'free_creation_drop_on_canvas': 'Drop files onto the canvas',
  'free_creation_reference_assets': 'Reference assets',
  'free_creation_asset_picker_title': 'Reference from asset library',
  'free_creation_asset_picker_description': 'Reuse character, scene, and prop images without uploading them again.',
  'free_creation_asset_picker_empty': 'No assets with images in this category',
  'free_creation_asset_selected': '{{count}} assets selected',
  'free_creation_action_read_only': 'This action is unavailable in read-only mode',
  ...
  'free_creation_reference_roles_incomplete': 'Choose a purpose for every bound resource',
  'free_creation_reference_roles_incompatible': 'One or more resources are not supported by the selected model',
  'free_creation_reference_role_limit': 'The selected model accepts fewer resources for this purpose',
  'free_creation_reference_role_first_frame': 'First frame',
  'free_creation_reference_role_last_frame': 'Last frame',
  'free_creation_reference_role_reference_image': 'Reference image',
  'free_creation_reference_role_reference_video': 'Reference video',
  'free_creation_reference_role_reference_audio': 'Reference audio',
  ...
  'free_creation_preview_truncated': 'The file is long; only the first 120,000 characters are shown.',
  'free_creation_add_reference': 'Add to composer',
  'free_creation_remove_reference': 'Remove reference',
  'free_creation_upload_reference': 'Upload reference',
  'free_creation_more_actions': 'More actions',
  'free_creation_delete': 'Delete',
  'free_creation_delete_selected': 'Delete selected',
  'free_creation_hide': 'Hide',
  'free_creation_restore': 'Restore',
  'free_creation_selected': 'Selected',
  'free_creation_shortcuts': 'Keyboard shortcuts',
  'free_creation_relations': 'Content relationships',
  'free_creation_relations_selected': 'Selected only',
  'free_creation_relations_all': 'All in view',
  'free_creation_relations_off': 'Hide relationships',
  'free_creation_relations_limited': '{{count}} additional relationships are hidden to keep the canvas responsive.',
  'free_creation_relation_summary': '{{upstream}} sources, {{downstream}} derived results',
  'free_creation_relation_summary_short': '{{upstream}} sources · {{downstream}} results',
  'free_creation_relation_details': 'Content relationships',
  'free_creation_relation_close': 'Close relationship details',
  'free_creation_relation_unavailable': 'Source unavailable',
  'free_creation_relation_upstream': 'Sources ({{count}})',
  'free_creation_relation_downstream': 'Derived results ({{count}})',
  'free_creation_relation_no_upstream': 'No source content',
  'free_creation_relation_no_downstream': 'No derived results',
  'free_creation_relation_role_first_frame': 'First frame',
  'free_creation_relation_role_last_frame': 'Last frame',
  'free_creation_relation_role_reference_image': 'Image reference',
  'free_creation_relation_role_reference_video': 'Video reference',
  'free_creation_relation_role_reference_audio': 'Audio reference',
  'free_creation_relation_role_prompt_context': 'Text context',
  'free_creation_relation_role_edit_source': 'Edit source',
  'free_creation_relation_role_subtitle_source': 'Subtitle source video',
  'free_creation_relation_role_subtitle_render': 'Subtitle render',
  'free_creation_relation_role_reference': 'Reference',
  'free_creation_continue_from_result': 'Create a new work from this result',
  'free_creation_continue_ready': 'The result and its settings are ready in the composer.',
  'free_creation_continue_model_unavailable': 'The original model is unavailable. Automatic selection is now active.',
  'free_creation_continue_settings_adjusted': 'Some original settings are no longer supported. Review the highlighted current values before generating.',
  'free_creation_continue_draft_conflict_title': 'Keep or replace the current draft?',
  'free_creation_continue_draft_conflict_description': 'The composer already contains unsent content. Choose how to use this result.',
  'free_creation_continue_add_reference_only': 'Add as reference only',
  'free_creation_continue_replace_draft': 'Replace current draft',
  'free_creation_composer_expand': 'Expand the creation composer',
  'free_creation_composer_collapse': 'Collapse the creation composer',
  'free_creation_start_creating': 'Start creating',
  'free_creation_composer_reference_count': '{{count}} references',
  'free_creation_shortcut_undo': 'Undo the last canvas change',
  'free_creation_shortcut_redo': 'Redo the last canvas change',
  'free_creation_shortcut_select_all': 'Select all visible cards',
  'free_creation_shortcut_reference': 'Reference a card in the composer',
  'free_creation_shortcut_preview': 'Preview card content',
  'free_creation_shortcut_move': 'Move a card',
  'free_creation_shortcut_pan': 'Pan the canvas',
  'free_creation_shortcut_zoom': 'Zoom the canvas',
  'free_creation_shortcut_combo_reference': 'Ctrl/Cmd + click',
  'free_creation_shortcut_combo_preview': 'Double-click',
  'free_creation_shortcut_combo_move': 'Drag card to move',
  'free_creation_shortcut_combo_pan': 'Space + drag',
  'free_creation_shortcut_combo_zoom': 'Alt + wheel',
  'free_creation_shortcut_snap': 'Temporarily disable element snapping',
  'free_creation_shortcut_combo_snap': 'Alt + drag',
  'free_creation_hide_from_canvas': 'Hide from canvas',
  'free_creation_add_selected_references': 'Reference selected files ({{count}})',
  'free_creation_hide_selected': 'Hide selected ({{count}})',
  'free_creation_restore_selected': 'Restore selected ({{count}})',
  'free_creation_restore_to_canvas': 'Restore to canvas',
  'free_creation_show_hidden': 'Show hidden work ({{count}})',
  'free_creation_restore_all_hidden': 'Restore all hidden items ({{count}})',
  'free_creation_editing_result': 'Editing: {{prompt}}',
  'free_creation_cancel_edit': 'Exit editing',
  'free_creation_image_parameters': 'Image parameters',
  'free_creation_video_parameters': 'Video parameters',
  'free_creation_export': 'Export',
  'free_creation_export_project_backup': 'Export project backup',
  'free_creation_export_project_backup_hint': 'Complete project ZIP that can be imported from the project list',
  'free_creation_export_selected': 'Export selected work',
  'free_creation_export_request': 'Export current request',
  'free_creation_export_all': 'Export all completed work',
  'free_creation_export_started': 'Work export started',
  'free_creation_export_failed': 'Work export failed: {{message}}',
  'free_creation_merge_selected': 'Merge selected videos',
  'free_creation_merge_started': 'Video merge started',
  'free_creation_merge_failed': 'Video merge failed: {{message}}',
  'free_creation_group_selected': 'Group selected items',
  'free_creation_ungroup': 'Ungroup items',
  'free_creation_group_label': 'Group {{count}}',
  'free_creation_arrange_all': 'Arrange all assets',
  'free_creation_fit_all': 'Fit all assets',
  'free_creation_fit_selected': 'Fit selected assets',
  'free_creation_minimap': 'Canvas minimap',
  'free_creation_arrange_selected': 'Arrange selected assets',
  'free_creation_tools': 'Creative tools',
  'free_creation_storyboard_plan': 'Plan storyboard',
  'free_creation_storyboard_title': 'Storyboard plan',
  'free_creation_storyboard_subtitle': 'Organize shots first, then generate storyboard images in one pass. Direct video generation stays unchanged.',
  'free_creation_storyboard_loading': 'Preparing storyboard draft…',
  'free_creation_storyboard_name': 'Storyboard name',
  'free_creation_storyboard_default_title': 'Untitled storyboard',
  'free_creation_storyboard_shot_title': 'Shot {{index}} title',
  'free_creation_storyboard_shot_prompt': 'Shot {{index}} prompt',
  'free_creation_storyboard_move_up': 'Move shot up',
  'free_creation_storyboard_move_down': 'Move shot down',
  ...
  'free_creation_voice_action': 'Add voice',
  'free_creation_voice_title': 'Generate voice',
  'free_creation_voice_text': 'Voice text',
  'free_creation_voice_select': 'Voice',
  'free_creation_voice_loading': 'Loading voices…',
  'free_creation_voice_unavailable': 'Voice generation is unavailable',
  'free_creation_voice_generate': 'Generate voice',
  'free_creation_subtitle_action': 'Add subtitles',
  'free_creation_subtitle_title': 'Add subtitles',
  'free_creation_subtitle_video': 'Video',
  'free_creation_subtitle_text': 'Subtitle text',
  'free_creation_subtitle_duration': 'Video duration (seconds)',
  'free_creation_subtitle_create': 'Create subtitles',
  'free_creation_subtitle_update': 'Update subtitles',
  'free_creation_subtitle_delete': 'Delete subtitles',
  'free_creation_subtitle_badge': '{{count}} subtitle track(s)',
  'free_creation_subtitle_video_required': 'Generate a video before adding subtitles',
  ...
  'home_hero_title': 'Make the next frame yours.',
  'home_hero_subtitle': 'Start with a thought. Choose only the controls that change the result, then keep every creation inside its project.',
  'home_output_type': 'Output type',
  'home_prompt_label': 'Creation prompt',
  'home_prompt_placeholder': 'Describe the image or motion you want to see...',
  'home_image': 'Image',
  'home_video': 'Video',
  'home_model': 'Model',
  'home_model_auto': 'Automatic',
  'home_model_search': 'Search models',
  'home_model_no_results': 'No matching models',
  'home_model_keyboard_hint': 'Type a letter to jump to a model',
  'home_ratio': 'Ratio',
  'home_resolution': 'Resolution',
  'home_size': 'Size',
  'home_image_settings': 'Image settings',
  'home_video_settings': 'Video settings',
  'home_width': 'Width W',
  'home_height': 'Height H',
  'home_size_hint': 'Enter either edge to update the other from the current ratio. Final size follows the selected model limits.',
  'home_quantity': 'Quantity',
  'home_duration': 'Video generation time',
  'home_duration_minimum': 'Minimum {{value}} seconds',
  'home_auto': 'Auto',
  'home_generate': 'Generate',
  'home_enter_agent': 'Open Agent',
  'home_generating': 'Creating...',
  'home_projects_eyebrow': 'Project library',
  'home_projects_title': 'Recent projects',
  'home_projects_count': '{{count}} projects',
  'home_projects_view_all': 'View all',
  'home_projects_empty': 'Your projects will appear here.',
  'home_projects_empty_hint': 'Write a prompt above to create your first free project.',
  'home_new_project_hint': 'Open the full workflow',
  'phase_creative': 'Creative',
  ...
  'content_mode_free_desc': 'Prompt to result — generate images, videos, or edits directly inside the project without scripts, episodes, or a fixed route.',
  'aspect_ratio_1_1': 'Square 1:1',
  'aspect_ratio_4_3': 'Standard 4:3',
  'aspect_ratio_3_4': 'Portrait 3:4',
  'aspect_ratio_21_9': 'Widescreen 21:9',
  ...
  'importing': 'Importing...',
  'import_zip': 'Import project ZIP',
  'import_project_zip_only': 'Only MatrixSpooll project ZIP backups can be imported',
  ...
  'about_title': 'About MatrixSpooll',
  'about_intro': 'Review this deployment version’s origin, license, modification notice, and corresponding source.',
  'about_loading': 'Loading legal information…',
  'about_origin_title': 'Project origin',
  'about_origin_description': 'MatrixSpooll is a modified version of ArcReel and preserves the attribution and source link required by the original project.',
  'about_modified_title': 'Modified version notice',
  'about_product': 'Product',
  'about_modified_by': 'Modified by',
  'about_modification_date': 'Relevant modification date',
  ...
  'about_resources_title': 'Related resources',
  'about_disclaimer': 'Disclaimer & terms of use',
  'system_config_title': 'System configuration and API access management',
  'account_security': 'Account security',
  'account_security_nav': 'Account security',
  'change_password': 'Change password',
  'change_password_description': 'Set a permanent password after using a temporary password. Other devices will be signed out.',
  'current_password': 'Current password',
  'new_password': 'New password',
  'confirm_password': 'Confirm new password',
  'password_requirements': 'Use at least 8 characters.',
  'password_mismatch': 'The new passwords do not match.',
  'password_change_success': 'Password changed. Other devices have been signed out.',
  'password_change_failed': 'Password change failed. Please try again.',
  'password_change_unavailable': 'Password changes are unavailable for this session.',
  ...
  'saving_nickname': 'Saving...',
  'nickname_saved': 'Nickname updated.',
  'nickname_save_failed': 'Failed to update nickname, please retry.',
  'avatar_label': 'Avatar',
  'avatar_upload': 'Upload avatar',
  'avatar_uploading': 'Uploading...',
  'avatar_remove': 'Remove avatar',
  'avatar_hint': 'JPG, PNG or WebP, up to 2MB.',
  ...
  'agent_failure_diagnosis_model_or_endpoint_incompatible': 'The configured Anthropic Messages endpoint cannot use this model. Run the connection test in Agent settings. If the provider only exposes OpenAI Chat Completions, use the model vendor’s Anthropic-compatible endpoint or another provider that supports Anthropic Messages.',
  ...
  'project_member_username_placeholder': 'Enter an exact username',
  'project_member_role': 'Project role',
  'project_member_add': 'Add members',
  'project_member_add_title': 'Add members',
  'project_member_add_hint': 'Select users to add to this project.',
  'project_member_add_selected': 'Add selected ({{count}})',
  'project_member_candidates_empty': 'No users available to add.',
  'project_member_selected_count': '{{count}} selected',
  'project_role_editor_hint': 'Can edit project content, create generation tasks, and manage project settings (members excluded).',
  'project_role_viewer_hint': 'Read-only access to view project content and generated results.',
  'project_member_account': 'Account',
  'project_member_actions': 'Actions',
  'project_role_owner': 'Owner',
  'project_role_editor': 'Editor',
  'project_role_viewer': 'Viewer',
  'project_member_remove': 'Remove',
  'project_member_no_action': 'No action',
  'project_members_loading': 'Loading members...',
  'project_members_empty': 'No project members yet.',
  'project_members_request_failed': 'Could not load project members.',
  'project_member_added': 'Member added.',
  'project_member_updated': 'Member role updated.',
  'project_member_removed': 'Member removed.',
  'project_owner_transfer_title': 'Transfer ownership',
  'project_owner_transfer': 'Transfer',
  'project_owner_transfer_hint': 'The new owner must already be a project member. You will become an editor.',
  'project_owner_transfer_empty': 'No other members yet. Add members before transferring ownership.',
  'project_owner_transfer_confirm_title': 'Transfer project ownership?',
  'project_owner_transfer_confirm_description': 'Transfer ownership to {{username}}? You will no longer control member access.',
  'project_owner_transferred': 'Project ownership transferred.',
  'project_member_remove_confirm_title': 'Remove project member?',
  'project_member_remove_confirm_description': 'Remove {{username}} from this project?',
  'project_members_saving': 'Saving...',
  ...
  'resolution_default_label': 'Default resolution',
  'resolution_default_help': 'Default tier sent to the provider when a generation request carries no explicit resolution; does not change the options offered in the composer.',
  'capability_custom_value_placeholder': 'Custom value',
  'capability_custom_add': 'Add custom value',
  'capability_custom_ratio_invalid': 'Ratio must be width:height (e.g. 16:9)',
  'sync_capabilities_button': 'Sync capabilities from docs',
  'sync_capabilities_running': 'Syncing…',
  'sync_capabilities_done': 'Sync finished: {{updated}} updated, {{unchanged}} unchanged, {{nodecl}} without params, {{failed}} failed',
  'capability_source_user_badge': 'Manual',
  'capability_source_endpoint_badge': 'Default',
  'capability_clear_override': 'Undo manual change',
  'vendor_declaration_active': 'Auto-synced',
  'sync_capabilities_failed': 'Capability sync failed',
  'vendor_capability_badge': 'Vendor docs',
  'vendor_capability_badge_title': 'Capabilities from vendor docs, synced {{time}}',
  'supported_resolutions_label': 'Resolution tiers',
  'supported_resolutions_help': 'Resolution tiers offered in the composer; click a chip to adjust. Custom values are sent to the API as-is.',
  'supported_ratios_label': 'Aspect ratios',
  'supported_ratios_help': 'Aspect ratios offered in the composer; click a chip to adjust.',
  ...
  'endpoint_anyfast_seedance_display': 'AnyFast Seedance Video',
  ...
  'version_download_media': 'Download this version',
  ...
  'skill_name_free_creation': 'Free creation',
  ...
  'project_page_summary': 'Showing {{start}}-{{end}} of {{total}} projects',
  'project_previous_page': 'Previous page',
  'project_next_page': 'Next page',
  ...
  'raw_error': 'Raw Error',
  'raw_openai_error': 'OpenAI contrast probe error',
  'is_active': 'ACTIVE',
  ...
  'openai_compat_probe': 'OpenAI contrast probe',
  'diagnosis_missing_anthropic_suffix': 'Detected missing anthropic suffix; auto-discovered the correct endpoint.',
  'diagnosis_openai_compat_only': 'This provider exposes the model through OpenAI Chat Completions only, which Claude Agent cannot use. Use the model vendor’s Anthropic Messages-compatible endpoint or choose a provider that supports Anthropic Messages.',
  ...
  'free_creation_session_summary': 'Creation requests',
  'free_creation_session_count': '{{count}} requests',
  'free_creation_session_empty': 'No generation requests yet',
  'free_creation_request_history': 'Request history',
  'free_creation_toggle_session_summary': 'Toggle request summary',
  'free_creation_bound_resources': '{{count}} bound resources',
  'free_creation_request_results': '{{completed}}/{{total}} results',
  'free_creation_status_partial': 'Partially completed',
  'free_creation_mode_t2v': 'Text to video',
  'free_creation_mode_first_frame': 'First-frame guidance',
  'free_creation_mode_first_last_frame': 'First-to-last frame',
  'free_creation_mode_reference_image': 'Reference image',
  'free_creation_mode_reference_video': 'Reference video',
};
