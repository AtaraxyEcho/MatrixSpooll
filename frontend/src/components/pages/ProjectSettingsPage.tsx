  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      await API.updateProject(projectName, {
        ...
        // ad/free 项目不使用固定工作流的默认镜头时长，省略该键
        ...(contentMode === "ad" || contentMode === "free" ? {} : { default_duration: defaultDuration }),
      ...
      <header className="app-topbar-surface">
        <div className="app-topbar-content app-topbar-content--wide app-topbar-inner app-project-settings-topbar">
          ...
          >
            ...
            <span className="hidden sm:inline">{t("back_to_project")}</span>
          </button>
                ...
                <fieldset>
                  ...
                  <AspectRatioPicker
                    ...
                    onChange={(nextAspectRatio) => {
                      ...
                      if (
                        initialRef.current.aspectRatio &&
                        nextAspectRatio !== initialRef.current.aspectRatio
                      ) {
