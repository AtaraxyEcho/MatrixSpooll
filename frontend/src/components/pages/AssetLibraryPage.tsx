    ...
    <div className="relative flex min-h-screen flex-col bg-bg text-text">
      <header className="app-topbar-surface">
        <div className="app-topbar-content app-topbar-content--wide app-topbar-inner app-library-topbar">
          ...
          <div className="app-library-topbar__actions flex shrink-0 items-center gap-2">
            <div className="relative">
              ...
              <input
                ...
                className={`${INPUT_CLS} w-[min(240px,38vw)] pl-8`}
              />
            </div>
            <button
              type="button"
        ...
        <div
          ...
          className="app-topbar-content app-topbar-content--wide app-library-tabs items-center gap-2 pb-3"
        >
