...
export function GlobalHeader({ onNavigateBack, variant = "workflow" }: GlobalHeaderProps) {
  ...
  return (
    <>
      <header className="app-topbar-surface app-topbar-inner app-workspace-topbar">
        {/* ---- Left: back + project menu ---- */}
        <div className="app-workspace-topbar__left flex items-center gap-2">
          <button
            type="button"
        ...
        <div className="app-workspace-topbar__actions">
          ...
          <div className="app-workspace-topbar__usage relative" ref={usageAnchorRef}>
            <button
              type="button"
