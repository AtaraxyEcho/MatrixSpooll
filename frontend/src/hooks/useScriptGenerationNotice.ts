 ...
 *
 * 工具名是 SDK 注册后的全限定名 mcp__matrixspooll__<id>，与 ToolCallWithResult 的解析口径
 * 一致。仅覆盖剧本/规范化两类文本生成工具；分镜/视频等长耗时工具已有任务队列 HUD。
 */
const SCRIPT_GENERATION_TOOL_NAMES = new Set([
  "mcp__matrixspooll__generate_episode_script",
  "mcp__matrixspooll__normalize_drama_script",
]);
