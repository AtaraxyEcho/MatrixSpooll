...
vi.mock("@/components/canvas/EpisodeSourceReview", () => ({
...
vi.mock("@/components/canvas/reference/ReferenceVideoCanvas", () => ({
...
vi.mock("@/components/canvas/grid/GridImageToVideoCanvas", () => ({
...
vi.mock("@/components/canvas/lorebook/CharacterCard", () => ({
  CharacterCard: ({
    name,
    onSave,
    onGenerate,
...
vi.mock("@/components/canvas/lorebook/SceneCard", () => ({
  SceneCard: ({
    name,
    onUpdate,
    onGenerate,
...
vi.mock("@/components/canvas/lorebook/PropCard", () => ({
  PropCard: ({
    name,
    onUpdate,
    onGenerate,
...
vi.mock("@/components/canvas/lorebook/ProductsPage", () => ({
  ProductsPage: ({
    products,
    onUpdateProduct,
    onGenerateProduct,
...
vi.mock("@/components/canvas/lorebook/AddCharacterForm", () => ({
  AddCharacterForm: ({
    onSubmit,
    onCancel,
  }: {
