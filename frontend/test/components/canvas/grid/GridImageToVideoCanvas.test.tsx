...
import { GridImageToVideoCanvas } from "@/components/canvas/grid/GridImageToVideoCanvas";

vi.mock("@/components/canvas/timeline/ScriptReviewGate", () => ({
  ScriptReviewGate: () => <div data-testid="script-review-gate" />,
}));
vi.mock("@/components/canvas/timeline/EpisodeHeader", () => ({
  EpisodeHeader: () => <div data-testid="episode-header" />,
}));
vi.mock("@/components/canvas/grid/GridPreviewView", () => ({
  GridPreviewView: () => <div data-testid="grid-preview-view" />,
}));
vi.mock("@/components/canvas/timeline/ShotSplitView", () => ({
  ShotSplitView: ({
    onGenerateVideo,
  }: {
    onGenerateVideo?: (
