...
Run: `cd /Users/pollochen/MyProjects/MatrixSpooll/.worktrees/feature/episode-cost-estimation && uv run alembic revision --autogenerate -m "add segment_id to api_calls"`
