...
This guide walks you through deploying MatrixSpooll from scratch and creating your first AI video or free creation that you can preview, roll back, and export.

## What You Will Build {#what-you-will-build}

By the end of this guide, you will be able to:

1. Start MatrixSpooll with Docker;
2. Sign in to the workspace and configure model providers;
3. Create a project from a novel, finished screenplay, ad/short video, or free creation;
4. Generate characters, scenes, props, storyboards, and video clips;
5. Monitor task status and costs;
6. Compose a drama episode, export a draft and generated clips for further post-production, or generate media directly in the free canvas.
...
- MatrixSpooll can estimate costs before generation and record actual usage afterward.
...
MatrixSpooll uses two types of credentials for different purposes.
...
You can use Anthropic's official service or a compatible service supported by MatrixSpooll, and configure the Base URL and model name as needed.
...
MatrixSpooll currently includes presets for these providers:
...
MatrixSpooll builds characters and shots from the author's supplied content. It should not rewrite a finished screenplay as if it were an ordinary novel.
...
- **Free Creation Mode**: Skips source files, scripts, and episodes; enter a prompt in the project to generate an image, video, or edit directly.

Fixed workflow modes also require `storyboard` or `reference_video` at project creation. Free creation does not choose a generation route and stores `generation_mode: null`.
