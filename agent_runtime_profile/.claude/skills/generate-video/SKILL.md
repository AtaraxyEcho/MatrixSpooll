...
| 操作 | 工具 |
|------|------|
| 整集生成（默认操作） | `mcp__matrixspooll__generate_video_episode({"script": "episode_1.json", "narration_delivery": chosen_narration_delivery})` |
| 断点续传 | `mcp__matrixspooll__generate_video_episode({"script": "episode_1.json", "narration_delivery": chosen_narration_delivery, "resume": true})` |
| 单场景 | `mcp__matrixspooll__generate_video_scene({"script": "episode_1.json", "scene_id": "E1S01", "narration_delivery": chosen_narration_delivery})` |
| 批量自选 | `mcp__matrixspooll__generate_video_selected({"script": "episode_1.json", "scene_ids": ["E1S01", "E1S05", "E1S10"], "narration_delivery": chosen_narration_delivery})` |
| 自选 + 续传 | `mcp__matrixspooll__generate_video_selected({"script": "episode_1.json", "scene_ids": [...], "narration_delivery": chosen_narration_delivery, "resume": true})` |
| 全部待处理（独立模式） | `mcp__matrixspooll__generate_video_all({"script": "episode_1.json", "narration_delivery": chosen_narration_delivery})` |
...
| 操作 | 工具 |
|------|------|
| 重新生成单个 unit | `mcp__matrixspooll__generate_video_scene({"script": "episode_1.json", "scene_id": "E1U2", "narration_delivery": chosen_narration_delivery})` |
| 重新生成多个 unit | `mcp__matrixspooll__generate_video_selected({"script": "episode_1.json", "scene_ids": ["E1U2", "E1U3"], "narration_delivery": chosen_narration_delivery})` |
...
```text
mcp__matrixspooll__generate_video_episode({"script": "episode_1.json", "narration_delivery": "use_tts",
